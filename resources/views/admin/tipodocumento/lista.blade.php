    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <a href="{{route('tipodocumento.create')}}"><button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Agregar</button></a>
            </div>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form id="frmeliminar{{$item->id}}" method="post" action="{{route('tipodocumento.destroy',$item->id)}}" class="form-inline">
                                @csrf
                                @method('DELETE')
                                <a class="btn btn-sm btn-warning" href="{{ route('tipodocumento.edit',$item->id) }}"><i class="fas fa-edit"></i></a>
