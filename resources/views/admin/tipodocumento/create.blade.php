...
<div class='container-fluid'>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-primary">Configuración de documentos
        </h1>
    </div>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Nuevo documento</h6>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form method="POST" action="{{route('tipodocumento.store')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tipodocumento" value="{{old('tipodocumento')}}" autofocus class="form-control" autocomplete="off"/>
                </div>
                <div class="form-group">
