...
<div class='container-fluid'>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Actualizar genero</h6>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form method="POST" action="{{route('genero.update',$genero->id)}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="genero" value="{{$genero->genero}}" class="form-control" autofocus autocomplete="off"/>
                </div>
                <div class="form-group">
