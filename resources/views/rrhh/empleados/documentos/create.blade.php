...
<div class='container-fluid'>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="frmempleado" method="POST" action="{{route('empleadodocumento.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-xl-2">
                        <div class="row mb-3">
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-12 mt-2">
                                <h5 class="font-weight-bold text-primary">Nuevo documento</h5>
                                <hr>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{old('numerodocumento')}}" name="numerodocumento" required/>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Fecha expedición</label>
                                    <input type="date" class="form-control" name="fechaexpedicion"/>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
