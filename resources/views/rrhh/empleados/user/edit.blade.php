...
<div class='container-fluid'>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="frmempleado" method="POST" action="{{route('empleadouser.update',$empleadouser->id)}}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-xl-2">
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-12 mt-2">
                                <h5 class="font-weight-bold text-primary">Actualizar inicio sesión</h5>
                                <hr>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="idusuario" autofocus required>
                                        ...
                                        <option @if($empleadouser->idusuario==$item->id) {{'selected'}} @endif value="{{$item->id}}">{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
