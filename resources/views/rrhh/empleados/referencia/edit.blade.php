...
<div class='container-fluid'>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form id="frmempleado" method="POST" action="{{route('empleadoreferencia.update',$empleadoreferencia->idempleado)}}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-xl-2">
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tipo" autofocus required>
                                        <option @if($empleadoreferencia->tipo=="Personal") {{'selected'}} @endif value="Personal">Personal</option>
                                        <option @if($empleadoreferencia->tipo=="Familiar") {{'selected'}} @endif value="Familiar">Familiar</option>
                                        <option @if($empleadoreferencia->tipo=="Trabajo") {{'selected'}} @endif value="Trabajo">Trabajo</option>
                                        <option @if($empleadoreferencia->tipo=="Otra") {{'selected'}} @endif value="Otra">Otra</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-8">
                                <div class="form-group">
                                    <label>Nombre</label>
                                    <input value="{{$empleadoreferencia->nombre}}" type="text" class="form-control" name="nombre"/>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="form-group">
                                    <label>Contacto</label>
                                    <input value="{{$empleadoreferencia->contacto}}" type="text" class="form-control" name="contacto"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
