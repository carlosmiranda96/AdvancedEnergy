(function ($) {
    ...
    var defaults = {
      date: null,
      weekDayLength: 1,
      prevButton: '<i class="fas fa-angle-left" style="color:white"></i>',
      nextButton: '<i class="fas fa-angle-right" style="color:white"></i>',
      monthYearSeparator: " ",
      ...
      todayButtonContent: '<i class="fas fa-calendar"></i> Hoy',
    ...
    function generateTodayButton() {
      return (
        ...
        "</button> " +
        '<button class="new-event" onclick="newEvent()"><i class="fas fa-plus"></i></button>'+
        "</div>"
      );
    }
